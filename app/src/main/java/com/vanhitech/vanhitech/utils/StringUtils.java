...
public class StringUtils {
     ...
     * @return
     */
    public static boolean isNull(Object obj, Context context, String nulltext) {
        if (obj == null) {
            T.showShort(context, nulltext);
            return true;
        }
        return false;
    }
     ...
     * @return
     */
    public static boolean isTureFlase(Boolean flag, Context context,String fmeassge) {
        if (flag) {
            return true;
        } else {
            T.showShort(context, fmeassge);
            return false;
        }
    }
    ...
    //验证邮箱
    public static boolean verEmail(String paramString) {
