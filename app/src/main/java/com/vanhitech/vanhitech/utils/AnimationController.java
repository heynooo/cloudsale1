...
//		baseOut(view, animation, durationMillis, delayMillis);//改了
		baseIn(view, animation, durationMillis, delayMillis);//改了
	}
	public static void slideOutte(View view, long durationMillis, long delayMillis) {
		TranslateAnimation animation = new TranslateAnimation(rela2, 0, rela2, 1, rela2, 0, rela2, 0);
//		baseOut(view, animation, durationMillis, delayMillis);//改了
		baseIn(view, animation, durationMillis, delayMillis);//改了
	}
	...
	public static void slideFadeInlete(View view, long durationMillis, long delayMillis) {
		TranslateAnimation animation1 = new TranslateAnimation(rela2, -1, rela2, 0, rela2, 0, rela2, 0);
		AlphaAnimation animation2 = new AlphaAnimation(0, 1);
		AnimationSet animation = new AnimationSet(false);
		animation.reset();
