...
import com.vanhitech.vanhitech.pulltorefresh.PullToRefreshListFooter;
import com.vanhitech.vanhitech.pulltorefresh.PullToRefreshListHeader;
...
public class PullToRefreshSwipeMenuListView extends ListView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		mHeaderView.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
			...
			public void onGlobalLayout() {
				mHeaderViewHeight = mHeaderViewContent.getHeight();// -0
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		return super.onInterceptTouchEvent(ev);//TODO
//		return  true;
	}
