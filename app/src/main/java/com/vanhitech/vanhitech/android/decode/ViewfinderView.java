...
package com.vanhitech.vanhitech.android.decode;
...
public final class ViewfinderView extends View
{
    ...
    private static final int        POINT_SIZE            = 6;//没改变之前是6
    ...
    private int margin = 0;//TODO 没改变之前是0
