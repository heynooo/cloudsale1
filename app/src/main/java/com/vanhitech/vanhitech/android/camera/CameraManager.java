...
package com.vanhitech.vanhitech.android.camera;
...
import com.vanhitech.vanhitech.android.camera.open.OpenCameraManager;
...
public final class CameraManager
{
    ...
    private static final int                 MIN_FRAME_WIDTH  = 600;//TODO扫描框大小
    private static final int                 MIN_FRAME_HEIGHT = 600;//TODO
...
//            int leftOffset = (screenResolution.x - width) / 2;//位置
            int leftOffset = (screenResolution.x - width) /2;//位置
