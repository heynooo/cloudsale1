...
import com.vanhitech.vanhitech.views.DoorLockTagView;
 ...
 * 更新描述   ${TODO}
 */
public class DoorLockActivity extends BaseActivityController {

    public DoorLockTagView mLrt_tag;
    ...
    public void initView() {
        ...
        //标签
        mLrt_tag = (DoorLockTagView) findViewById(R.id.doorLockTagView);
        fl_content = (FrameLayout) findViewById(R.id.fl_content);
        ActivityTitleManager.getInstance().init(this);
        ActivityTitleManager.getInstance().showCommonTitle();
        ActivityTitleManager.getInstance().changeTitle(UIUtils.getString(R.string.doorlock));
    ...
    public void initEvent() {
        super.initEvent();
        mLrt_tag.setOnTagChangeListener(new DoorLockTagView.OnTagChangeListener() {
            @Override
