...
import com.vanhitech.vanhitech.android.camera.CameraManager;
import com.vanhitech.vanhitech.android.decode.BeepManager;
import com.vanhitech.vanhitech.android.decode.CaptureActivityHandler;
import com.vanhitech.vanhitech.android.decode.InactivityTimer;
import com.vanhitech.vanhitech.android.decode.ViewfinderView;
import com.vanhitech.vanhitech.android.result.ResultHandler;
import com.vanhitech.vanhitech.android.result.ResultHandlerFactory;
...
public final class CaptureActivity extends BaseActivityController implements
	...
	public void onResume() {
		...
		viewfinderView = (ViewfinderView) findViewById(R.id.viewfinder_view);//TODO
		...
		ActivityTitleManager.getInstance().changehelpText("手输");

		Intent intent = getIntent();
		mPlace = intent.getStringExtra("place");


		ActivityTitleManager.getInstance().help.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent mIntent = new Intent();

				mIntent.setClass(mActivity, ImporSnActivity.class);
				mIntent.putExtra("place", mPlace);
		...
		handler = null;
		SurfaceView surfaceView = (SurfaceView) findViewById(R.id.preview_view);//TODO
	...
	public void handleDecode(Result rawResult, Bitmap barcode) {
		...
		Log.d(TAG, "result-->" + text);//意图带文本信息跳转
		Intent intent = new Intent();
		intent.setClass(this, ResultSNActivity.class);
		//mPlace
