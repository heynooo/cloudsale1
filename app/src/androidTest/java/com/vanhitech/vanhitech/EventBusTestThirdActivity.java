...
//
//
//public class EventBusTestThirdActivity extends AppCompatActivity {
//    Button button_one;
//    TextView textView_one,textView_two,textView_third,button_out;
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.event_bus_test_third_layout);
...
//        button_out=(TextView)this.findViewById(R.id.button_out);
////        button_one.setOnClickListener(new View.OnClickListener() {
////            @Override
////            public void onClick(View v) {
////                openActivity(EventBusTestTwoActivity.class);
////            }
////        });
