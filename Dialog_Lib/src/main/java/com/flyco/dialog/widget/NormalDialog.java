...
//----------0427----------------------------
    ...
    private int mTitleBgColor = Color.parseColor("#39A1E8");//TODO
//--------------------------------------
...
//        mTitleTextColor = Color.parseColor("#61AEDC");
        mTitleTextColor = Color.parseColor("#ffffff");//TODO 标题字体颜色 0427修改
        mTitleTextSize = 22f;
//        mContentTextColor = Color.parseColor("#383838");
        mContentTextColor = Color.parseColor("#aebecc"); //TODO   //字体颜色 0427
...
//            mTvTitle.setGravity(Gravity.CENTER_VERTICAL);
            ...
            mTvTitle.setGravity(Gravity.CENTER);
            mTvTitle.setPadding(dp2px(0), dp2px(5), dp2px(0), dp2px(5));
        }
